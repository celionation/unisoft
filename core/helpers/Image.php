...
class Image
{
    public static function crop($src_image_path,$dest_image_path,$max_size = 600)
    {
    ...
    public static function profile_thumb($image_path)
    {
        $crop_size = 600;
        ...
        if(!file_exists($thumbnail)){
            self::crop($image_path,$thumbnail,$crop_size);
        }
