        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="/admin/course/create/new" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="Create"><i class="fas fa-plus-circle"></i> New Course</a>
                    </div>
                </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach ($courses as $key => $course) : ?>
                            <tr>
                                <th><?= $key + 1 ?></th>
                                <td class="text-capitalize"><?= $course->course ?></td>
                                <td class="text-capitalize"><?= $course->department ?></td>
                                <td class="text-end">
